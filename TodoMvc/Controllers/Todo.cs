...
public class Todo : Controller
{
  ...
  public async Task<IActionResult> Create([Bind("Id,Title,Done,CreatedAt,UpdatedAt,User")] Models.Todo todo)
  {
  ...
  [HttpPost]
  [ValidateAntiForgeryToken]
  public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Done,CreatedAt,UpdatedAt,User")] Models.Todo todo)
  {
    if (id != todo.Id)
    {
      return NotFound();
